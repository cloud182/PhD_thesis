...
The extension of optical emission (which is usually traced with the the [\ion{O}{III}]$\lambda5007$ line) is of the order of kiloparsecs and in the most extended ionization cones it can be traced up to $15$--$20\,\si{kpc}$ \citep{Mulchaey96,Schmitt03}.
