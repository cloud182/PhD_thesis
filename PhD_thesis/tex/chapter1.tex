...
This interaction between the AGN and the host galaxy can happes in two ways: via the interaction of the interstellar medium with AGN produced outflows, the so called radiative mode, ... .
For a complete review on AGN feedback see \citep{Fabian12}.
