...
In the latter case, it might be consistent with a scenario of episodic activity described previously. 
...
In this chapter, I presented the first results of a survey of NLS1s carried out with the JVLA at $5$ GHz in A configuration.
In particular, I reported the detection of extended emission in the S-NLS1 Mrk\,783.
...
These facts, and the very steep measured spectral indexes, led me to hypothesize that the extended emission might be a relic and that the source might be in a quiescent period of its activity cycle, which is in agreement with the theoretical model by \citet{Czerny09} and the young age scenario for NLS1s \citep{Mathur00}. 
Further observations are needed both in radio and in other bands to confirm these results and to investigate the nature of this object in more detail. 
